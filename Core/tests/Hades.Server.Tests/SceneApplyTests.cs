...
/// SceneApplyCommands, UnityPlugin) that applies the WHOLE batch inside one handler body, one Undo
...
/// those are proven against a real Editor in UnityPlugin/Tests/Editor/SceneApplyCommandsTests.cs.
/// </summary>
