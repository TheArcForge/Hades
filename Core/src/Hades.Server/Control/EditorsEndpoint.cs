...
/// "hades-script-editing" - confirmed by reading UnityPlugin/Assets/Hades/Tools/ProjectCommands.cs
...
/// UnityPlugin/Assets/Hades/Runtime/ReloadGate.cs directly - <c>Acquire</c> for a different id while one
...
/// Lock/UnlockReloadAssemblies call site exists anywhere outside UnityPlugin's own IEditorLockApi.cs).
...
///
/// <item><b>Idempotency has three layers, matching UnityPlugin's <c>Runtime.ReloadGate.Release</c>'s
/// own real contract (confirmed by reading UnityPlugin/Assets/Hades/Runtime/ReloadGate.cs directly -
