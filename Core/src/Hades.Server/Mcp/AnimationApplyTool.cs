...
/// <see cref="Hades.Tools.AnimationApplyCommands"/> (UnityPlugin), which applies every operation
...
/// (UnityPlugin) is what renames it back to 'path' before calling animation.create_controller/
