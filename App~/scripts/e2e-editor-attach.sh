...
#
# Usage:
#   App~/scripts/e2e-editor-attach.sh
#
...
#      Plugin~ source into its Assets/Hades/ (a plain file copy - Unity mints its own .meta files
...
PLUGIN_SRC="$REPO_ROOT/Plugin~/Assets/Hades"
