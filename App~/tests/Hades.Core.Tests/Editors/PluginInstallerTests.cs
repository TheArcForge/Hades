...
public sealed class PluginInstallerTests : IDisposable
{
    ...
    public void Install_MatchesTheRealPluginSourceTreeExactly()
    {
        ...
        // the asmdef come from Plugin~/Assets/Hades (the folder this app installs), but Contract/
        // comes from App~/src/Hades.Contract/Wire - the sources this app itself compiled against,
        // NOT the separately-maintained Plugin~/Assets/Hades/Contract/ copy used for Unity-side
        ...
        const string PluginSourceDir = "/Users/mike/Projects/Hades/Plugin~/Assets/Hades";
        const string ContractSourceDir = "/Users/mike/Projects/Hades/App~/src/Hades.Contract/Wire";
