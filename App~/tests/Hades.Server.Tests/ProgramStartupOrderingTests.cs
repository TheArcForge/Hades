...
/// spawn succeed" (Swift, Shell~/HadesSupervision, not exercised here) - must never become
...
public sealed class ProgramStartupOrderingTests
{
    ...
    /// Shell~/HadesSupervision/Tests' own `ReaperForceKillTests` comment on the same standard);
