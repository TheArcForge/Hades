...
///
/// 1. The live parser actually reads Plugin~'s current source correctly (spot checks against
...
public class PluginWireContractTests
{
    ...
    // ==================================================================== 1. the parser reads real Plugin~ source correctly
    ...
    /// the real Plugin~ - proving the table is read from source TEXT, not hand-copied, so a real
    /// rename in Plugin~/Assets/Hades/Tools would flow through automatically the next time this
