...
/// disk at install time. The app is a compiled binary and <c>Plugin~/</c> is a source tree that
...
/// itself compiled against) rather than the separately maintained <c>Plugin~/Assets/Hades/Contract/</c>
