...
//
// Mirrors, field for field, the record types in App~/src/Hades.Server/Control/{SummaryEndpoint,
// ProjectsEndpoint,EditorsEndpoint}.cs and PingResult in App~/src/Hades.Server/Mcp/SummaryTools.cs.
