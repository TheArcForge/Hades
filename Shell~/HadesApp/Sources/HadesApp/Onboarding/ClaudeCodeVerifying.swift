...
/// address `Plugin-ClaudeCode~/.claude-plugin/plugin.json` declares - gets back a well-formed
...
public struct LiveClaudeCodeVerifier: ClaudeCodeVerifying {
    ...
    /// (`App~/src/Hades.Server/Program.cs`'s own comment: "the SDK owns... protocol-version
