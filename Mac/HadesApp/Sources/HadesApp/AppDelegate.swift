...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    /// "--project", <repo>/Core/src/Hades.Server, "--no-launch-profile"]`, mirroring
    /// `Core/scripts/e2e-editor-attach.sh`'s own established convention - whenever the bundled
    ...
    private static func makeConfiguration() -> CoreSupervisor.Configuration {
        ...
        let serverProject = repoRoot.appendingPathComponent("Core/src/Hades.Server").path
